...
import { T as Textbox } from './Textbox-4b7f8a69.js';
import { a as Button, B as Block } from './Button-bd009e9a.js';
import { $ as $format } from './Index-7fdff9d2.js';
/* empty css                                                */import './index-10ead756.js';
import Index from './Index-24a33ce1.js';
import './BlockTitle-16231197.js';
import './Info-47f6c44f.js';
...
function create_if_block_2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			p.innerHTML = /*auth_message*/ ctx[0];
		},
		p(ctx, dirty) {
			if (dirty & /*auth_message*/ 1) p.innerHTML = /*auth_message*/ ctx[0];		},
		d(detaching) {
			if (detaching) {
				detach(p);
			}
...
//# sourceMappingURL=Login-2c406349.js.map
