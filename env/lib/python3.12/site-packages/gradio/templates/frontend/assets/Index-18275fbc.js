...
// (126:4) {#each _value ? _value?.annotations : [] as ann, i}
function create_each_block_1(ctx) {
	...
	return {
		c() {
			...
			if (!src_url_equal(img.src, img_src_value = /*ann*/ ctx[27].image.url)) attr(img, "src", img_src_value);

			attr(img, "style", img_style_value = /*color_map*/ ctx[9] && /*ann*/ ctx[27].label in /*color_map*/ ctx[9]
			? null
			: `filter: hue-rotate(${Math.round(/*i*/ ctx[29] * 360 / /*_value*/ ctx[14]?.annotations.length)}deg);`);

			toggle_class(img, "active", /*active*/ ctx[15] == /*ann*/ ctx[27].label);
			toggle_class(img, "inactive", /*active*/ ctx[15] != /*ann*/ ctx[27].label && /*active*/ ctx[15] != null);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_value*/ 16384 && !src_url_equal(img.src, img_src_value = /*ann*/ ctx[27].image.url)) {
				attr(img, "src", img_src_value);
			}

			if (dirty[0] & /*color_map, _value*/ 16896 && img_style_value !== (img_style_value = /*color_map*/ ctx[9] && /*ann*/ ctx[27].label in /*color_map*/ ctx[9]
			? null
			: `filter: hue-rotate(${Math.round(/*i*/ ctx[29] * 360 / /*_value*/ ctx[14]?.annotations.length)}deg);`)) {
...
// (143:5) {#each _value.annotations as ann, i}
function create_each_block(ctx) {
	let button;
	let t0_value = /*ann*/ ctx[27].label + "";
	let t0;
	let t1;
	let mounted;
	let dispose;
	...
	function mouseover_handler() {
		return /*mouseover_handler*/ ctx[22](/*ann*/ ctx[27]);
	}

	function focus_handler() {
		return /*focus_handler*/ ctx[23](/*ann*/ ctx[27]);
	}

	function click_handler() {
		return /*click_handler*/ ctx[26](/*i*/ ctx[29], /*ann*/ ctx[27]);
	}
	...
	return {
		c() {
			...
			set_style(button, "background-color", /*color_map*/ ctx[9] && /*ann*/ ctx[27].label in /*color_map*/ ctx[9]
			? /*color_map*/ ctx[9][/*ann*/ ctx[27].label] + '88'
			: `hsla(${Math.round(/*i*/ ctx[29] * 360 / /*_value*/ ctx[14].annotations.length)}, 100%, 50%, 0.3)`);
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(button, "mouseout", /*mouseout_handler*/ ctx[24]),
					listen(button, "blur", /*blur_handler*/ ctx[25]),
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty[0] & /*_value*/ 16384 && t0_value !== (t0_value = /*ann*/ ctx[27].label + "")) set_data(t0, t0_value);
...
// (117:3) <Empty size="large" unpadded_box={true}>
...
// (92:0) <Block  {visible}  {elem_id}  {elem_classes}  padding={false}  {height}  {width}  allow_overflow={false}  {container}  {scale}  {min_width} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_value, color_map, show_legend, label, active, height, show_label, gradio, loading_status*/ 58104 | dirty[1] & /*$$scope*/ 1) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*value, old_value, gradio, latest_promise*/ 3670024) {
			{
				if (value !== old_value) {
				...
				if (value) {
					...
					$$invalidate(21, latest_promise = current_promise);
...
//# sourceMappingURL=Index-18275fbc.js.map
