...
import { S as SelectSource } from './SelectSource-e8dd6fee.js';
import { W as Webcam } from './ImageUploader-bad42a24.js';
import './Image-e7664ad6.js';
/* empty css                                                */import { l as loadFfmpeg, t as trimVideo, V as Video$2, p as prettyBytes, a as playable } from './Video-0f7b23bd.js';
export { b as loaded } from './Video-0f7b23bd.js';
import { T as Trim, P as Pause, a as Play } from './Trim-0317ad89.js';
import { U as Undo } from './Undo-6c110254.js';
import { f as format_time, u as uploadToHuggingFace } from './utils-013c0d40.js';
import { p as prepare_files, u as upload } from './index-10ead756.js';
...
export { default as BaseExample } from './Example-42e57db6.js';
...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_video, _subtitle, label, show_label, show_download_button, sources, active_source, mirror_webcam, include_audio, autoplay, root, gradio, dragging, loading_status*/ 33243618 | dirty[1] & /*$$scope*/ 16384) {
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*_video, _subtitle, label, show_label, autoplay, show_share_button, show_download_button, gradio, loading_status*/ 12828962 | dirty[1] & /*$$scope*/ 16384) {
				block_changes.$$scope = { dirty, ctx };
			}
...
// (120:1) <Block   {visible}   variant={value === null && active_source === "upload" ? "dashed" : "solid"}   border_mode={dragging ? "focus" : "base"}   padding={false}   {elem_id}   {elem_classes}   {height}   {width}   {container}   {scale}   {min_width}   allow_overflow={false}  >
function create_default_slot_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*gradio*/ 131072 | dirty[1] & /*$$scope*/ 16384) {
...
// (82:1) <Block   {visible}   variant={value === null && active_source === "upload" ? "dashed" : "solid"}   border_mode={dragging ? "focus" : "base"}   padding={false}   {elem_id}   {elem_classes}   {height}   {width}   {container}   {scale}   {min_width}   allow_overflow={false}  >
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*value*/ 1) {
			{
				if (value != null) {
					$$invalidate(22, _video = value.video);
					$$invalidate(23, _subtitle = value.subtitles);
				} else {
		...
		if ($$self.$$.dirty[0] & /*value, old_value, gradio*/ 268566529) {
			{
...
//# sourceMappingURL=index-6c56f0db.js.map
