import { w as writable, S as Static } from './Index-7fdff9d2.js';
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			set_style(span1, "transform", /*$open*/ ctx[1] ? "rotate(0)" : "rotate(90deg)");
			attr(button, "class", "label-wrap svelte-s1r2yt");
			toggle_class(button, "open", /*$open*/ ctx[1]);
			set_style(div, "display", /*$open*/ ctx[1] ? "block" : "none");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*toggle_open*/ ctx[3]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
			...
			if (default_slot) {
				if (default_slot.p && (!current || dirty & /*$$scope*/ 32)) {
					update_slot_base$1(
						...
						/*$$scope*/ ctx[5],
						!current
						? get_all_dirty_from_scope$1(/*$$scope*/ ctx[5])
						: get_slot_changes$1(default_slot_template, /*$$scope*/ ctx[5], dirty, null),
						null
					);
				}
			}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ('initial_open' in $$props) $$invalidate(4, initial_open = $$props.initial_open);
		if ('label' in $$props) $$invalidate(0, label = $$props.label);
		if ('$$scope' in $$props) $$invalidate(5, $$scope = $$props.$$scope);
	};

	return [label, $open, open, toggle_open, initial_open, $$scope, slots];
}

class Accordion extends SvelteComponent$1 {
	constructor(options) {
		super();
		init$1(this, options, instance$1, create_fragment$1, safe_not_equal$1, { initial_open: 4, label: 0 });
	}
}
...
// (21:1) <Accordion {label} initial_open={open}>
...
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*open*/ 16) accordion_changes.initial_open = /*open*/ ctx[4];
...
//# sourceMappingURL=Index-04122f45.js.map
