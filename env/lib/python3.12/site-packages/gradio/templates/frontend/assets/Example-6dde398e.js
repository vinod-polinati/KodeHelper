...
function create_fragment(ctx) {
	let div;
	let t_value = (/*value*/ ctx[0] !== null ? /*value*/ ctx[0] : "") + "";
	let t;
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*value*/ 1 && t_value !== (t_value = (/*value*/ ctx[0] !== null ? /*value*/ ctx[0] : "") + "")) set_data(t, t_value);
...
//# sourceMappingURL=Example-6dde398e.js.map
