...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			if (!src_url_equal(img.src, img_src_value = /*icon*/ ctx[7].url)) attr(img, "src", img_src_value);
		...
		p(ctx, dirty) {
			if (dirty & /*icon*/ 128 && !src_url_equal(img.src, img_src_value = /*icon*/ ctx[7].url)) {
...
// (80:0) <BaseButton  {size}  {variant}  {elem_id}  {elem_classes}  {visible}  on:click={open_file_upload}  {scale}  {min_width}  {disabled} >
...
function create_fragment$1(ctx) {
	...
	basebutton.$on("click", /*open_file_upload*/ ctx[14]);
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, icon, value*/ 1048705) {
...
function create_fragment(ctx) {
	...
	uploadbutton.$on("click", /*click_handler*/ ctx[17]);
	uploadbutton.$on("change", /*change_handler*/ ctx[18]);
	uploadbutton.$on("upload", /*upload_handler*/ ctx[19]);
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*disabled*/ 16384) uploadbutton_changes.disabled = /*disabled*/ ctx[14];
			...
			if (dirty & /*$$scope, label, gradio*/ 1056784) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*interactive*/ 65536) {
...
//# sourceMappingURL=Index-f8cab700.js.map
