...
if ("attachShadow" in Element.prototype && "adoptedStyleSheets" in Document.prototype) {
...
const ENTRY_CSS = "./assets/index-138adf03.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-7fdff9d2.js').then(n => n.I),true?["./Index-7fdff9d2.js","./Index-b2fdba73.css"]:void 0,import.meta.url)).default;
  _res();
}
...
export { __vitePreload as _, prefix_css as a, mount_css as m, prepare_files as p, upload as u };
//# sourceMappingURL=index-10ead756.js.map
